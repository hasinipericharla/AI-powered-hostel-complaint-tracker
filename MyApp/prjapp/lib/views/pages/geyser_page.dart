  ...
  Future<void> fetchComplaints() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          "${ApiConfig.baseUrl}/api/complaints?type=geyser",
        ),
        ...
        return Container(
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              leading:
                  const Icon(Icons.hot_tub, color: Color(0xFFFF3D00)),
              title: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text(
...
/// ================= FILTER LOGIC (shared by UI + download) =================
  ...
  Future<void> downloadComplaintsPdf() async {
    ...
    final file = File(
      '${dir.path}/geyser_complaints_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
