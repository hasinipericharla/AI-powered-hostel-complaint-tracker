...
// //     return ServicePage(title: 'Laundary', color: Colors.orange);
// //   }
// // }
...
//     {'block':'LH2','email':'pooja@vit.com','regNo':'22BCE2201','place':'Laundry','status':'Pending','filedDate':'2025-11-01','description':'Washing machine not working.'},
//   ];

//   final List<Map<String,dynamic>> reported = [
//     {'block':'MH6','email':'arun@vit.com','regNo':'22BCE2202','place':'MH6 Laundry','status':'Reported','filedDate':'2025-11-03','description':'Dryer stopped mid-cycle.'},
//   ];
...
//     return Scaffold(appBar: AppBar(title: const Text("Laundry Complaints"), backgroundColor: Colors.purple, centerTitle:true, leading: IconButton(icon: const Icon(Icons.arrow_back), onPressed: ()=> Navigator.pop(context))), body: pages[selectedIndex], bottomNavigationBar: BottomNavigationBar(currentIndex:selectedIndex, onTap:(i)=> setState(()=> selectedIndex = i), selectedItemColor: Colors.purple, unselectedItemColor: Colors.grey, items: const [
  ...
  Future<void> fetchComplaints() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          "${ApiConfig.baseUrl}/api/complaints?type=laundry",
        ),
        ...
        return Container(
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              leading:
                  const Icon(Icons.local_laundry_service_sharp, color: Color(0xFFFF3D00)),
              title: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text(
