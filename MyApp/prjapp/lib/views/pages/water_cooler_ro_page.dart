  ...
  Future<void> fetchComplaints() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          "${ApiConfig.baseUrl}/api/complaints?type=waterCoolerRo",
        ),
        ...
        return Container(
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              leading:
                  const Icon(Icons.water_drop, color: Color(0xFFFF3D00)),
              title: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text(
...
/// ================= FILTER LOGIC (shared by UI + download) =================
  ...
  Future<void> downloadComplaintsPdf() async {
    ...
    final file = File(
      '${dir.path}/waterCoolerRO_complaints_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
  ...
  child: Column(
    ...
    children: [
      ...
      Text(
        'Welcome Back, Water Cooler/RO Incharge 👋',
        style: TextStyle(
          color: Colors.white,
          fontSize: 13,
          fontWeight: FontWeight.bold
