...
// class Lh3Cts extends StatefulWidget {
//   const Lh3Cts({super.key});

//   @override
//   State<Lh3Cts> createState() => _Lh3CtsPage();
// }

// class _Lh3CtsPage extends State<Lh3Cts> {
//   int selectedIndex = 0;
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text("Wifi Complaints-LH3"),
...
class LH3CTSPage extends StatefulWidget {
  const LH3CTSPage({super.key});

  @override
  State<LH3CTSPage> createState() => _LH3CTSPageState();
}

class _LH3CTSPageState extends State<LH3CTSPage> {
  int si = 0;
  ...
  child: Column(
    ...
    children: [
      ...
      Text(
        'Welcome Back, Wifi Incharge LH3 👋',
        style: TextStyle(
          color: Colors.white,
          fontSize: 13,
          fontWeight: FontWeight.bold
