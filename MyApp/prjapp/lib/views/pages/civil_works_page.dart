...
//         Uri.parse(
//           "${ApiConfig.baseUrl}/api/complaints?type=civil",
//         ),
...
//               leading:
//                   const Icon(Icons.construction, color: Color(0xFFFF3D00)),
//               title: Column(
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   const Text(
...
//       ),
//       Text(
//         'Welcome Back, Civil Works Incharge👋',
//         style: TextStyle(
//           color: Colors.white,
//           fontSize: 13,
//           fontWeight: FontWeight.bold
...
class _CivilWorksPageState extends State<CivilWorksPage> {
  ...
  Future<void> downloadComplaintsPdf() async {
    ...
    final file = File(
      '${dir.path}/civil_works_complaints_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
