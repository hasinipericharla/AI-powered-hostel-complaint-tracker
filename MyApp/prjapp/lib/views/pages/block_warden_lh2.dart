// // file: lib/pages/block_warden_lh2.dart
// import 'package:flutter/material.dart';

// class BlockWardenLH2Page extends StatefulWidget {
//   const BlockWardenLH2Page({super.key});

//   @override
//   State<BlockWardenLH2Page> createState() => _BlockWardenLH2PageState();
// }

// class _BlockWardenLH2PageState extends State<BlockWardenLH2Page> {
//   int selectedIndex = 0;
//   Map<int, bool> expandedMap = <int, bool>{};

//   final List<Map<String, dynamic>> complaints = [
//     {'block':'LH2','email':'student1@vit.edu','regNo':'22BCE2001','place':'LH2 Room 201','status':'Pending','filedDate':'2025-10-20','description':'Light not working.'},
//     {'block':'LH2','email':'student2@vit.edu','regNo':'22BCE2002','place':'LH2 Room 202','status':'In Progress','filedDate':'2025-10-21','description':'Fan noisy.'},
//   ];

//   final List<Map<String, dynamic>> reported = [
//     {'block':'LH2','email':'student3@vit.edu','regNo':'22BCE2003','place':'LH2 Room 203','status':'Reported','filedDate':'2025-11-01','description':'Socket issue.'},
//   ];

//   Widget _tile(Map<String, dynamic> c, int idx, {bool isReported = false}) {
//     return Container(
...
//     return Scaffold(
//       appBar: AppBar(title: const Text("Block Warden - LH2"), centerTitle: true, backgroundColor: Colors.orange, leading: IconButton(icon: const Icon(Icons.arrow_back), onPressed: () => Navigator.pop(context))),
...
//           .where((c) =>
//               (c['block'] ?? '').toString().trim().toUpperCase() == 'LH2')
//           .toList();
...
//       return const Center(child: Text("No complaints found for LH2 block."));
//     }
...
//     }
//     if (reported.isEmpty) {
//       return const Center(child: Text("No reported complaints for LH2 block."));
//     }
//     return RefreshIndicator(
//       onRefresh: fetchComplaints,
//       child: ListView.builder(
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text("Block Warden - LH2"),
//         centerTitle: true,
