...
//     return ServicePage(title: 'AC', color: Colors.orange);
//   }
// }
...
//     {'block':'LH1','email':'vishal@vit.com','regNo':'22BCE1501','place':'LH1 Room 104','status':'Pending','filedDate':'2025-11-01','description':'AC not cooling.'},
//     {'block':'MH5','email':'geeta@vit.com','regNo':'22BCE1502','place':'MH5 Room 301','status':'In Progress','filedDate':'2025-11-02','description':'AC remote not working.'},
//   ];

//   final List<Map<String,dynamic>> reported = [
//     {'block':'MH2','email':'naina@vit.com','regNo':'22BCE1503','place':'MH2 Room 208','status':'Reported','filedDate':'2025-11-03','description':'Strange smell from AC.'},
//   ];
...
//     return Scaffold(appBar: AppBar(title: const Text("AC Complaints"), backgroundColor: Colors.cyan, centerTitle: true, leading: IconButton(icon: const Icon(Icons.arrow_back), onPressed: ()=> Navigator.pop(context))), body: pages[selectedIndex], bottomNavigationBar: BottomNavigationBar(currentIndex:selectedIndex, onTap:(i)=> setState(()=> selectedIndex = i), selectedItemColor: Colors.cyan, unselectedItemColor: Colors.grey, items: const [
  ...
  Future<void> fetchComplaints() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          "${ApiConfig.baseUrl}/api/complaints?type=ac",
        ),
        ...
        return Container(
          ...
          child: Theme(
            ...
            child: ExpansionTile(
              ...
              leading:
                  const Icon(Icons.ac_unit, color: Color(0xFFFF3D00)),
              title: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text(
