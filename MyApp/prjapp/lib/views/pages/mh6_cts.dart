...
// class Mh6Cts extends StatefulWidget {
//   const Mh6Cts({super.key});

//   @override
//   State<Mh6Cts> createState() => _Mh6CtsPage();
// }

// class _Mh6CtsPage extends State<Mh6Cts> {
//   int selectedIndex = 0;
...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text("Wifi Complaints-MH6"),
...
class MH6CTSPage extends StatefulWidget {
  const MH6CTSPage({super.key});

  @override
  State<MH6CTSPage> createState() => _MH6CTSPageState();
}

class _MH6CTSPageState extends State<MH6CTSPage> {
  int si = 0;
  ...
  child: Column(
    ...
    children: [
      ...
      Text(
        'Welcome Back, Wifi Incharge MH6 👋',
        style: TextStyle(
          color: Colors.white,
          fontSize: 13,
          fontWeight: FontWeight.bold
