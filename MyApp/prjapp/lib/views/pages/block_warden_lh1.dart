...
//       final response = await http.get(
//         Uri.parse("http://10.248.203.102:5000/api/complaints?block=LH1"),
//         headers: {"Authorization": "Bearer $token"},
//       );

//       if (response.statusCode == 200) {
//         final decoded = jsonDecode(response.body);
//          // 🔍 DEBUG: see actual complaint JSON
//   print("First complaint:");
//   print(decoded['complaints'][0]);
...
//         Uri.parse("http://10.248.203.102:5000/api/complaints/$id/status"),
//         headers: {
//           "Content-Type": "application/json",
//           "Authorization": "Bearer $token",
//         },
...
//   /// 🔥 Helper for neat colon alignment
